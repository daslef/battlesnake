...
func SetupBoard(gameMap GameMap, settings settings.Settings, width, height int, snakeIDs []string) (*rules.BoardState, error) {
...
// 				if editor.IsOccupied(p, true, true) {
// 					continue
// 				}
...
// 	if !editor.IsOccupied(centerCoord, true, true) {
