    ...
    return (
        <tr className="match__participant participant">
            <td className="participant__image">
                <img src={participant.languageIcon} alt="programming language" className="participant__language" />
            </td>
            <td className="participant__team">
                {participant.snakeAuthor}
            </td>
            {isGameCompleted && (
                <td className="participant__controls participant__controls">
                    <button type="button" className="participant__controls__control control" onClick={() => handleClick('firstPlaces')}>
                        <img src={digitOneSvg} alt="first place" className="control__icon control__icon--gold" />
                    </button>
                    <button type="button" className="participant__controls__control control" onClick={() => handleClick('secondPlaces')}>
                        <img src={digitTwoSvg} alt="second place" className="control__icon control__icon--silver" />
                    </button>
                    <button type="button" className="participant__controls__control control" onClick={() => handleClick('aggressiveBonuses')}>
